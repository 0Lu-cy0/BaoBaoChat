 ...
 * Upload avatar user
 */
const uploadAvatar = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    configureCloudinary();
 ...
 */
const uploadMessageImage = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    configureCloudinary();
 ...
 */
const uploadGroupAvatar = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    configureCloudinary();
